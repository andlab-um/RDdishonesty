...
fitsF=fits
save(fitsF, file="/media/haiyanwu/HDD2/fmri2019/7.DDM-related/fitting_code/results_tddm/fits_all_tddm.RData")
write.csv(fitsF, file = "/media/haiyanwu/HDD2/fmri2019/7.DDM-related/fitting_code/results_tddm/fits_all_tddm.csv")
...
save(fitsF, file="/media/haiyanwu/HDD2/xinyi_RanDishonesty/behav_ddm/fitting_code/results_tddm/fits_all_tddm.RData")
write.csv(fitsF, file = "/media/haiyanwu/HDD2/xinyi_RanDishonesty/behav_ddm/fitting_code/results_tddm/fits_all_tddm.csv")
