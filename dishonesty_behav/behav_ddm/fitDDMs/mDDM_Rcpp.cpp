...
struct ddm2w : public Worker {
  ...
  ddm2w(const double drate_m, const double drate_c, const double nDT, const double moneydiff, const double consdiff, NumericVector vecOut , GEN gen)
    : drate_m(drate_m), drate_c(drate_c), nDT(nDT), moneydiff(moneydiff), consdiff(consdiff), gen(gen), vecOut(vecOut) {}
...
// [[Rcpp::export]]
NumericVector mddm_parallel(double drate_m, double drate_c,  double nDT, double moneydiff, double consdiff, unsigned int N) {
  ...
  // create the worker
  ddm2w ddm2w(drate_m, drate_c, nDT,moneydiff, consdiff, vecOut, gen);
