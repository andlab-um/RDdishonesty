...
sourceCpp(paste0(dir,"/fitDDMs/mDDM_Rcpp.cpp"))
...
fitsF=fits
save(fitsF, file=paste0(dir,"/parameter_recovery/fitSimulatedData/results_mDDM_tSims/simFits_mFit_tSim.RData"))
write.csv(fitsF, file = paste0(dir,"/parameter_recovery/fitSimulatedData/results_mDDM_tSims/simFits_mFit_tSim.csv"))
