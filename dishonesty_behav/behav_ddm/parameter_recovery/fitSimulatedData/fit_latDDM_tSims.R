...
sourceCpp(paste0(dir,"/fitDDMs/latDDM_Rcpp.cpp"))
...
fitsF=fits
save(fitsF, file=paste0(dir,"/parameter_recovery/fitSimulatedData/results_mDDM_tSims/simFits_latFit_tSim.RData"))
write.csv(fitsF, file = paste0(dir,"/parameter_recovery/fitSimulatedData/results_mDDM_tSims/simFits_latFit_tSim.csv"))
